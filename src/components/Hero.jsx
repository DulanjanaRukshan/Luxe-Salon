...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative h-[100dvh] overflow-hidden bg-dark">
      <Slider {...settings} className="h-full hero-slider">
        {slides.map((slide, i) => (
          <div key={i} className="relative h-[100dvh] w-full focus:outline-none overflow-hidden">
              ...
              <AnimatePresence mode='wait'>
                <div key={i}>
                  <motion.h1
                    ...
                    animate="visible"
                    exit="hidden"
                    className="text-4xl md:text-6xl lg:text-8xl font-serif font-bold mb-4 md:mb-6 drop-shadow-xl"
                  >
                    {slide.title}
                  </motion.h1>
                  <motion.p
                    ...
                    className="text-lg md:text-2xl lg:text-3xl font-light mb-8 md:mb-10 text-gray-200 max-w-xl md:max-w-2xl mx-auto tracking-wide px-4"
                  >
                    {slide.sub}
                  </motion.p>
